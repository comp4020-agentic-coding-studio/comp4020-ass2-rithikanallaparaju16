...
The working log this project was written from. [PROCESS.md](PROCESS.md) is the
account. This file is the evidence behind it, kept whole so nothing is lost to
the word count.
