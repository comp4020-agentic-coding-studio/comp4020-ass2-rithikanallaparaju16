...
**Classes are recorded.** Recordings exist so that a week you miss is not a
week you lose. They are for catching up, not for attending.

## What actually gets marked

| Half | What counts |
| --- | --- |
| Attendance, 50% | Being physically present at the lecture. Your best **9 of 12** weeks count in full. |
| Participation, 50% | Doing the crit activity. Your best **9 of 12** crits count in full. |
...
This needs saying precisely, because the obvious version of a participation
mark would wreck this course.

Participation here means **you did the activity**. You made the sandwich. You
sat the ten minutes. You brought the message, thought about the decision, took
your turn or passed on it. That is the whole standard.

It does not mean speaking volume. Talking more earns you nothing extra.
Talking less costs you nothing. **A student who passes on every single share,
all semester, can score full marks on this component.** The
[pass rule](/lectures/01-not-that-serious/) is not suspended by an assessment;
it is the reason this component is defined the way it is. A course about
anxiety that paid people to speak up would be marking the symptom.
...
would be dishonest to dress the argument up as a finding.

**And the critique is real.** Mandatory attendance policies assume a standard
body and a standard life. Students ration absences between medical
appointments and rest; disability accommodations often cannot flex attendance
specifically; undiagnosed students get no flexibility at all; and caring
responsibilities and money fall unevenly. Melissa Nicolas has written on the
ableist assumptions baked into these policies, and the empirical work on
inclusive alternatives is thin.
