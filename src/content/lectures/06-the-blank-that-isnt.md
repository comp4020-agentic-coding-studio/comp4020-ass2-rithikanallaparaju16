...
This is the strongest evidence in the lecture and it is worth knowing
precisely.
...
| --- | --- |
| Break on a phone | Took ~19% longer, solved ~22% fewer problems |
| The same break, not on a phone | Better on both measures |
...
Robertson and colleagues (2023, *Nature Human Behaviour*) ran a registered
report across roughly 105,000 headline variants and 5.7 million clicks. Each
additional negative word in a headline of average length raised click-through
...
## The connection this course is actually making
...
## What this lecture will not tell you

The honest part, and it cuts against the lecture's own thesis.

- **The effects are small.** Orben and Przybylski (2019) ran a specification
  curve across data from 355,358 adolescents and found digital technology use
  explained at most about 0.4% of variance in wellbeing. Anyone telling you
  phones are the defining catastrophe of your generation is not describing
  this literature.
...
- **The passive-scrolling story is contested.** The most cited experiment
  ...
  *envy*, not numbing. And Valkenburg and colleagues (2022) argue the whole
  ...
  exchange on this that ends unresolved, which is what an honest open question
  looks like.
