...
marking:
  mode: holistic
  description:
    Judged on whether the activity would actually produce the discussion it
    is aiming for, not on production values or novelty for its own sake. A
    close variant of a crit from this course, honestly adapted to a new
